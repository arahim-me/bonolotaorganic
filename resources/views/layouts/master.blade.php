    ...
    <body>
        ...
        <div class="preloader position-fixed top-0 start-0 w-100 h-100 body-bg z-index-5">
            <div class="loader-img position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
                <img src="{{ asset('frontend') }}/assets/image/index/logo.png" class="width-88 width-xl-112 img-fluid" alt="logo">
            </div>
        </div>
        <!-- preloader end -->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content body-bg border-0 br-hidden">
                    <div class="modal-body p-0">
                        <button type="button" class="d-block secondary-btn font-12 position-absolute top-0 end-0 width-32 height-32 mst-15 mer-15 rounded-circle" data-bs-dismiss="modal" aria-label="Close"><i class="ri-close-large-line d-block lh-1"></i></button>
                        <div class="newsletter-info d-flex flex-wrap">
                            <div class="col-12 col-md-6">
                                <div class="newsletter-image">
                                    <img src="{{ asset('frontend') }}/assets/image/newsletter/newsletter-popup.jpg" class="w-100 img-fluid" alt="newsletter-popup">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 text-center ptb-30 plr-15 plr-md-30">
                                <div class="newsletter-content height-md-100 d-md-flex flex-md-column align-items-md-center justify-content-md-center">
                                    <div class="meb-26">Gift bundles for every type of person</div>
                                    <div class="w-100 pst-12 peb-16 text-uppercase bst beb">
                                        <h2 class="font-48 lh-1">20% off</h2>
                                        <span class="d-block primary-color mst-9">Limited time offers!</span>
                                    </div>
                                    <a href="collection.html" class="btn-style tertiary-btn mst-30">Collection</a>
                                    <div class="mst-26">
                                        <label class="d-inline-block cust-checkbox-label checkbox-hide">
                                            <input type="checkbox" id="popup-input" name="popup-input" class="cust-checkbox checkbox-hide-btn">
                                            <span class="d-block cust-check"></span>
                                            <span class="login-read">Don't show again</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row align-items-center header-area">
                            ...
                            <div class="col-6 col-xl-2 header-element header-logo">
                                <div class="header-theme-logo">
                                    <a href="index-2.html" class="d-inline-block theme-logo">
                                        <img src="{{ asset('frontend') }}/assets/image/index/logo.png" class="width-88 width-xl-112 img-fluid" alt="logo">
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="mainmenu-content">
                                    <div class="main-wrap">
                                        <ul class="menu-ul d-flex flex-wrap">
                                            <li class="menu-li">
                                                <a href="index-2.html" class="menu-link d-flex align-items-center ptb-5 plr-15">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-2">
                                                                <div class="banner-hover">
                                                                    <a href="index-2.html" class="d-block banner-img br-hidden">
                                                                        <img src="{{ asset('frontend') }}/assets/image/menu/menu-banner1.jpg" class="w-100 img-fluid" alt="menu-banner1">
                                                                    </a>
                                                                </div>
                                                                <a href="index-2.html" class="d-inline-block primary-link mst-15 heading-weight">01 Classic fashion</a>
                                                            </div>
                                                            <div class="col-xl-2">
                                                                <div class="banner-hover">
                                                                    <a href="index2.html" class="d-block banner-img br-hidden">
                                                                        <img src="{{ asset('frontend') }}/assets/image/menu/menu-banner2.jpg" class="w-100 img-fluid" alt="menu-banner2">
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <div class="col-xl-2">
                                                                <div class="banner-hover">
                                                                    <a href="index3.html" class="d-block banner-img br-hidden">
                                                                        <img src="{{ asset('frontend') }}/assets/image/menu/menu-banner3.jpg" class="w-100 img-fluid" alt="menu-banner3">
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <div class="col-xl-2">
                                                                <div class="banner-hover">
                                                                    <a href="index4.html" class="d-block banner-img br-hidden">
                                                                        <img src="{{ asset('frontend') }}/assets/image/menu/menu-banner4.jpg" class="w-100 img-fluid" alt="menu-banner4">
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <div class="col-xl-2">
                                                                <div class="banner-hover">
                                                                    <a href="index5.html" class="d-block banner-img br-hidden">
                                                                        <img src="{{ asset('frontend') }}/assets/image/menu/menu-banner5.jpg" class="w-100 img-fluid" alt="menu-banner5">
                                                                    </a>
                                                                </div>
                                                            ...
                                                            <div class="col-xl-2">
                                                                <div class="banner-hover">
                                                                    <a href="index6.html" class="d-block banner-img br-hidden">
                                                                        <img src="{{ asset('frontend') }}/assets/image/menu/menu-banner6.jpg" class="w-100 img-fluid" alt="menu-banner6">
                                                                    </a>
                                                                </div>
                                                ...
                                                <div class="menu-dropdown menu-mega collapse position-absolute top-auto start-0 end-0 body-bg z-2 DropDownSlide box-shadow">
                                                    <div class="container ptb-25">
                                                        <div class="menu-overview">
                                                            ...
                                                            <span class="d-block ptb-5"><a href="{{route('login')}}" class="d-inline-block body-primary-color">Login</a></span>
                                                            <span class="d-block ptb-5"><a href="forgot-password.html" class="d-inline-block body-primary-color">Forgot password</a></span>
                                                            <span class="d-block ptb-5"><a href="{{route('register')}}" class="d-inline-block body-primary-color">Register</a></span>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="quickview-img-big quickview-slider-big position-relative br-hidden">
                                                <div class="swiper" id="quickview-slider-big">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-1.jpg" class="w-100 img-fluid" alt="product-1">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-2.jpg" class="w-100 img-fluid" alt="product-2">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-3.jpg" class="w-100 img-fluid" alt="product-3">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-4.jpg" class="w-100 img-fluid" alt="product-4">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-5.jpg" class="w-100 img-fluid" alt="product-5">
                                                        </div>
                                                    </div>
                                                    <div class="swiper-buttons">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="quickview-img-small quickview-slider-small">
                                                <div class="swiper" id="quickview-slider-small">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-1.jpg" class="w-100 img-fluid border-radius" alt="product-1">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-2.jpg" class="w-100 img-fluid border-radius" alt="product-2">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-3.jpg" class="w-100 img-fluid border-radius" alt="product-3">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-4.jpg" class="w-100 img-fluid border-radius" alt="product-4">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="{{ asset('frontend') }}/assets/image/product/product-5.jpg" class="w-100 img-fluid border-radius" alt="product-5">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-payment">
                                                ...
                                                <ul class="payment-ul">
                                                    <li class="payment-li ul-mt5 lh-0">
                                                        <a href="javascript:void(0)" class="d-block"><img src="{{ asset('frontend') }}/assets/image/other/paying-american.png" class="width-40 img-fluid border-radius" alt="paying-american"></a>
                                                        <a href="javascript:void(0)" class="d-block"><img src="{{ asset('frontend') }}/assets/image/other/paying-club.png" class="width-40 img-fluid border-radius" alt="paying-club"></a>
                                                        <a href="javascript:void(0)" class="d-block"><img src="{{ asset('frontend') }}/assets/image/other/paying-discover.png" class="width-40 img-fluid border-radius" alt="paying-discover"></a>
                                                        <a href="javascript:void(0)" class="d-block"><img src="{{ asset('frontend') }}/assets/image/other/paying-maestro.png" class="width-40 img-fluid border-radius" alt="paying-maestro"></a>
                                                        <a href="javascript:void(0)" class="d-block"><img src="{{ asset('frontend') }}/assets/image/other/paying-paypal.png" class="width-40 img-fluid border-radius" alt="paying-paypal"></a>
                                                        <a href="javascript:void(0)" class="d-block"><img src="{{ asset('frontend') }}/assets/image/other/paying-visa.png" class="width-40 img-fluid border-radius" alt="paying-visa"></a>
                                                    </li>
                        ...
                        <ul class="menu-ul">
                            <li class="menu-li bst">
                                <div class="menu-btn d-flex flex-row-reverse">
                                    ...
                                    <span class="width-calc-48 ptb-10 plr-15"><a href="index-2.html" class="d-inline-block body-color">Home</a></span>
                                </div>
                                <div class="menu-dropdown collapse" id="menu-home">
                                    <ul class="menudrop-ul">
                                        <li class="menudrop-li bst">
                                            <span class="d-block ptb-10 psl-20 per-15"><a href="index-2.html" class="d-inline-block body-color">01 Classic fashion</a></span>
                                        </li>
                                        <li class="menudrop-li bst">
                    ...
                    <div class="drawer-scrollable h-100 overflow-auto">
                        <div class="cart-drawer-table plr-15">
                            <div class="cart-drawer-info ptb-15 bst">
                                <div class="cart-drawer-content d-flex flex-wrap">
                                    <div class="cart-drawer-image width-88">
                                        <a href="product.html" class="d-block br-hidden"><img src="{{ asset('frontend') }}/assets/image/cart/cart-1.jpg" class="w-100 img-fluid" alt="cart-1"></a>
                                    </div>
                            ...
                            <div class="cart-drawer-info ptb-15 bst">
                                <div class="cart-drawer-content d-flex flex-wrap">
                                    <div class="cart-drawer-image width-88">
                                        <a href="product.html" class="d-block br-hidden"><img src="{{ asset('frontend') }}/assets/image/cart/cart-2.jpg" class="w-100 img-fluid" alt="cart-2"></a>
                                    </div>
                                    <div class="cart-drawer-info width-calc-88 psl-15">
                                        <div class="cart-drawer-detail">
                            ...
                            <div class="cart-drawer-info ptb-15 bst">
                                <div class="cart-drawer-content d-flex flex-wrap">
                                    <div class="cart-drawer-image width-88">
                                        <a href="product.html" class="d-block br-hidden"><img src="{{ asset('frontend') }}/assets/image/cart/cart-3.jpg" class="w-100 img-fluid" alt="cart-3"></a>
                                    </div>
                                    <div class="cart-drawer-info width-calc-88 psl-15">
                                        <div class="cart-drawer-detail">
                            ...
                            <div class="cart-drawer-info ptb-15 bst">
                                <div class="cart-drawer-content d-flex flex-wrap">
                                    <div class="cart-drawer-image width-88">
                                        <a href="product.html" class="d-block br-hidden"><img src="{{ asset('frontend') }}/assets/image/cart/cart-4.jpg" class="w-100 img-fluid" alt="cart-4"></a>
                                    </div>
                                    <div class="cart-drawer-info width-calc-88 psl-15">
                                        <div class="cart-drawer-detail">
                                    ...
                                    <div class="swiper-wrapper">
                                            ...
                                            <div class="drawer-recommended-product">
                                                <div class="row drawer-recommended-single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="product.html" class="pro-img"><img src="{{ asset('frontend') }}/assets/image/product/p-1.jpg" class="w-100 img-fluid" alt="p-1"></a>
                                                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="drawer-recommended-product">
                                                <div class="row drawer-recommended-single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="product.html" class="pro-img"><img src="{{ asset('frontend') }}/assets/image/product/p-3.jpg" class="w-100 img-fluid" alt="p-3"></a>
                                                    </div>
                                                    <div class="product-content">
                                                        <div class="pro-content">
                                                            <div class="product-title">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="drawer-recommended-product">
                                                <div class="row drawer-recommended-single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="product.html" class="pro-img"><img src="{{ asset('frontend') }}/assets/image/product/p-5.jpg" class="w-100 img-fluid" alt="p-5"></a>
                                                    </div>
                                                    <div class="product-content">
                                                        <div class="pro-content">
                                                            <div class="product-title">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="drawer-recommended-product">
                                                <div class="row drawer-recommended-single-product-wrap">
                                                    <div class="product-image">
                                                        <a href="product.html" class="pro-img"><img src="{{ asset('frontend') }}/assets/image/product/p-7.jpg" class="w-100 img-fluid" alt="p-7"></a>
                                                    </div>
                                                    <div class="product-content">
                                                        <div class="pro-content">
                                                            <div class="product-title">
        ...
        <div class="bottom-menu d-md-none position-sticky bottom-0 body-bg z-1 box-shadow">
            <div class="bottom-menu-element d-flex flex-wrap align-items-center">
                <div class="col">
                    <a href="index-2.html" class="d-flex flex-column align-items-center ptb-10 text-center">
