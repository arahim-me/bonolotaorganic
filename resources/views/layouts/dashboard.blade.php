...
<head>
    <meta charset="utf-8" />
    <title>@yield('title', 'Dashboard | Dashtrap - Responsive Bootstrap 5 Admin Dashboard')</title>
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    @if ((auth()->check() && auth()->user()->role_id == 1) || auth()->user()->role_id == 2)
                        ...
                        <li class="menu-item">
                            <a class='menu-link waves-effect waves-light' href='{{ route('users.index') }}'>
                        ...
                        <li class="menu-item">
                            <a class='menu-link waves-effect waves-light' href='{{ route('categories.index') }}'>
                                <span class="menu-icon"><i class="bx bx-bookmarks"></i></span>
                                <span class="menu-text">Categories</span>
                            </a>
                        </li>

                        <li class="menu-item">
                            <a class='menu-link waves-effect waves-light' href='{{ route('products.index') }}'>
                        ...
                        <li class="menu-item">
                            <a class='menu-link waves-effect waves-light' href='{{ route('facilities.index') }}'>
                        ...
                        <li class="menu-item">
                            <a class='menu-link waves-effect waves-light' href='{{ route('orders.index') }}'>
                                <span class="menu-icon"><i class="bx bx-cart"></i></span>
                                <span class="menu-text">Orders</span>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="#menuTables" data-bs-toggle="collapse"
                            ...
                            <div class="collapse" id="menuTables">
                                <ul class="sub-menu">
                                    <li class="menu-item">
                                        <a class='menu-link' href='{{route('payment-methods.index')}}'>
                                            <span class="menu-text">Payment Methods</span>
                                        </a>
                                    </li>
                                    <li class="menu-item">
                                        <a class='menu-link' href='{{ route('payment-gateways.index') }}'>
                    ...
                    <li class="menu-item">
                        <form method="POST" action="{{ route('logout') }}"
                            class="menu-link waves-effect waves-light">
                            @csrf
                            <button type="submit" class="menu-link btn btn-link bg-transparent p-0 text-start">
                                <span class="menu-icon"><i class="bx bx-power-off"></i></span>
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='{{ route('profile.edit') }}'>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="dropdown-item notify-item border-0 bg-transparent text-start">
